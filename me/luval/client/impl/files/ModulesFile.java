package me.luval.client.impl.files;
...
import me.luval.client.api.setting.Setting;
...
public class ModulesFile extends CustomFile {
    ...
    public void loadFile() throws IOException {
        ...
        for (Module module : Luval.INSTANCE.MODULE_MANAGER.getModules()) {
            ...
            ArrayList<Setting> settings = Luval.INSTANCE.SETTING_MANAGER.getSettingsForModule(module);
